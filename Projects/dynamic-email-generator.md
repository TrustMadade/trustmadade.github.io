...
- **Python 3**
  ...
  - Lists and loops
- **Jupyter Notebook**
  - Interactive coding & markdown documentation
...
- ✔️ Generated 20+ personalized emails with 100% accuracy.
- ✔️ Successfully applied fallback logic and string personalization.
- ✔️ Built reusable code structure for future marketing automation tasks.
